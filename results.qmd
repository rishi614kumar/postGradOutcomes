...
Certificates, for instance, often result in lower income compared to associate or Bachelors degrees for the upper echelon earnings. This could be because many pursuing certificates are transitioning into new fields, starting at entry-level positions in their new career paths.
...
For many students, location plays a crucial role in choosing a college. Some deliberately select schools in a different state from where they grew up to gain new experiences. While they may not plan to settle in the state where they attend college, it’s worth considering the earnings potential in that state - particularly when evaluating opportunities for internships or entry-level positions after graduation.
...
This plot shows income outcomes by state, validating the common intuition that more experience generally leads to higher earnings for any given state. For state-level analysis, it is important to note that there is no distinction on where the student was employed - that is to say that a Maine graduate could have been employed in South Carolina, but is still counted for Maine.

However, income levels still vary significantly between states. For instance, Rhode Island’s average median income one year after graduation rivals South Dakota’s ten year figure, highlighting disparities in job opportunities or possibly the dominant or prevalent industries in each state. States with hubs for higher paying industries like manufacturing, finance, or technology, such as Texas or Pennsylvania, tend to have higher earnings while rural or agriculture focused states, such as Oklahoma or Utah, remain lower.
...
This plot shows the difference between total graduates and those employed one year after graduation. Niche or specialized degrees, such as certificates and doctoral degrees, show higher employment rates, with relatively small gaps between graduates and employed individuals. In contrast, more general degrees like Associates, Baccalaureate, and Masters show noticeable gaps, indicating that a significant portion of graduates remain unemployed. Notably though, Associates degrees have a smaller unemployment gap than Baccalaureate degrees while Baccalaureate degrees have a larger unemployment gap than Masters degrees. This could be because the jobs available to people with Associates degrees are more widely available in general, such as for entry-level healthcare, office support, or IT support, meaning it is easier for them to find a job that matches their qualifications.
...
## What is the relation or growth potential between Year 1 and Year 10 earnings?
...
This plot then shows the change in average median earnings one year after graduation for each of the eight different degree levels. We see that only 2 degree levels, a professional doctorate and a one to two year certificate have seen a small increase in median earnings of less then \$500. A Masters degree and a two to four year certificate have seen the biggest decreases of around \$1000 and \$5,500 respectively. Note also that due to the matching process, the earnings decrease for Masters programs for example, cannot be caused by the addition of new types of Masters programs that are not attractive in the job market. The decrease is only calculated for Masters for which cohorts graduated in both 2001 and 2016.
